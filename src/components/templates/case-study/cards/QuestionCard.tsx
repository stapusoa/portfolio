...
const QuestionCard: React.FC<CardProps> = ({ image, question, statement }) => {
  ...
  return (
    <div
      className="relative w-full h-80 [perspective:800px] group cursor-pointer"
      ...
      >
        <div className="relative h-full overflow-hidden rounded-lg border-1 border-solid border-primary">
          <div className="absolute z-20 top-0 left-0 p-4">
            <h3 className="m-0 pb-2 font-sans font-medium text-primary tracking-wide leading-cozy text-2xl">
              {question}
            </h3>
            <p className="m-0 text-neutral-500 font-sans text-left text-lg font-light">
              {statement}
            </p>
          </div>
