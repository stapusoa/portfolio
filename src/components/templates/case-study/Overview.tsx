      ...
      <div className="pt-28 pb-12 z-32 flex flex-col items-start gap-8">
        <div className="flex flex-col items-start gap-2 w-full">
          <div className="py-2 text-left">
            <h2 className="text-3xl pb-8 font-semibold tracking-wide">overview</h2>
          </div>
          <div className="grid grid-flow-row auto-rows-min gap-8 items-start text-left w-full">
            ...
            <div className='m-0 p-0 col-start-2 col-span-3 row-span-1 font-sans font-light text-2xl leading-relaxed text-neutral-600'>
              <strong className='font-semibold'>The product - </strong>{overview}
            </div>
            ...
            <div className='col-start-2 col-span-3 font-sans font-light text-2xl leading-relaxed text-neutral-600'>
              <strong className='font-semibold'>Project duration - </strong>{duration}
            </div>
          </div>
        </div>
      </div>
      ...
      >
        ...
        <div className="flex flex-col items-start gap-1 w-full min-w-[320px] snap-center">
          <div className="p-0 text-left">
            <h3 className="m-0 font-sans font-light text-2xl text-neutral-600 tracking-wide">role</h3>
          </div>
          <ul className="p-0 list-disc text-left list-inside space-y-1">
            {role.map((item, index) => (
              <li key={index} className="text-neutral-600 font-sans font-light text-xl leading-tight">
                {item}
              </li>
            ))}
          </ul>
        ...
        <div className="flex flex-col items-start gap-2 w-full min-w-[320px] snap-center">
          <div className="p-0 text-left">
            <h3 className="m-0 font-sans font-light text-2xl text-neutral-600 tracking-wide">deliverables</h3>
          </div>
          <ul className="p-0 list-disc text-left list-inside space-y-1">
        ...
        <div className="flex flex-col items-start gap-2 w-full min-w-[320px] snap-center">
          <div className="p-0 text-left">
            <h3 className="m-0 font-sans font-light text-2xl text-neutral-600 tracking-wide">specifications</h3>
          </div>
          <ul className="p-0 list-disc text-left list-inside space-y-1">
