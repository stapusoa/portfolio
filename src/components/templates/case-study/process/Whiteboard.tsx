...
export function Whiteboard({
  ...
  return (
    <div className="bg-transparent mx-auto overflow-visible relative z-32 pt-12 pb-16 grid grid-cols-1 md:grid-cols-8 gap-8">
      ...
      {/* Text Section */}
      <p className="m-0 col-span-full md:col-span-2 text-left font-sans font-light text-2xl text-neutral-800 tracking-wide">
        ideation
      </p>

      {statement && (
        <p className="m-0 col-span-full md:col-span-6 text-left font-sans font-light text-2xl text-neutral-900 leading-relaxed">
          {statement}
        </p>
      )}
