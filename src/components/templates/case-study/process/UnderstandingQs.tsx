...
export function Understanding({ cards }: Questions) {
  return (
    <div className="bg-transparent mx-auto overflow-visible relative z-32 pt-12 pb-16 grid grid-cols-1 md:grid-cols-8 gap-8">
      ...
      <div className="col-span-full md:col-span-4 gap-8 order-1 md:order-3 grid grid-flow-row h-fit">
        <p className="m-0 p-0 w-full h-fit text-left font-sans font-light text-2xl text-neutral-800 tracking-wide">user story</p>
        <p className="m-0 p-0 w-full h-fit text-left font-sans font-light text-2xl text-neutral-900 leading-relaxed">
        ...
        <p className="m-0 p-0 w-full h-fit text-left font-sans font-light text-2xl text-neutral-800 tracking-wide">hypothesis</p>
        <p className="m-0 p-0 w-full h-fit text-left font-sans font-light text-2xl text-neutral-900 leading-relaxed">
