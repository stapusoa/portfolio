  ...
  return (
    <div className="bg-transparent mx-auto overflow-visible relative z-32 pt-12 pb-16 grid grid-cols-1 md:grid-cols-8 gap-8">
      ...
      <div className="col-span-full md:col-span-4 flex flex-col gap-4 order-1 md:order-3">
        <p className="m-0 text-left font-sans font-light text-2xl text-neutral-800 tracking-wide">
          goal
        </p>

        {statement && (
          <p className="m-0 text-left font-sans font-light text-2xl text-neutral-900 leading-relaxed">
            {statement}
          </p>
        )}
      </div>
