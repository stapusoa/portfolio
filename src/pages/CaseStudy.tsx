...
import { ArrowLeft, ArrowRight, ExternalLink, Target, Lightbulb, TrendingUp, Palette, Code, Copy, Check } from 'lucide-react'
...
export function CaseStudy() {
  ...
  const renderDesignSystemTab = (project: typeof caseStudies[0]) => {
    ...
    return (
      <TabsContent value="design-system" className="mt-8 relative min-h-screen">
        <div className="space-y-12">
          ...
          <div>
            ...
            <Button variant="ghost" className="pb-4" onClick={() => window.open(project.designSystemLink, "_blank")}
            >
              <span>View Full Design System</span><ArrowRight size={16} /></Button>
          ...
          <div className="relative mt-12 w-full z-20 h-dvh">
                    ...
                    <div>
                      ...
                      <div className="flex flex-wrap gap-2">
                        {component.variants.map((variant, vIndex) => (
                          <Badge key={vIndex} variant="default" color="neutral">{variant}</Badge>
                        ))}
                      </div>
                    </div>
                      ...
                      <div>
                        ...
                        <div className="flex flex-wrap gap-2">
                          {component.states.map((state, sIndex) => (
                            <Badge key={sIndex} variant="outline">{state}</Badge>
                          ))}
                        </div>
                      </div>
                    )}
                  ...
                  >
                    ...
                    <div>
                      ...
                      {phase.pages?.map((page, pageIndex) => (
                        <div key={pageIndex} className="col-start-1 col-span-8 border border-neutral-200 bg-white overflow-hidden rounded-lg p-6 mt-4">
                          <span className="flex items-center justify-center bg-mint-600 text-white font-medium rounded-md px-3 py-2 mb-2">
                            {page.page}
                          </span>
                          <ul>
