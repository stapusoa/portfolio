...
import { PhaseCard } from '@/components/common/cards/ExpandCard'
          ...
          <div className="text-left">
            ...
            <div className="mb-12 typography">
              ...
              <div className="flex items-left justify-left gap-x-4">
                <Button className="" variant="default" size="lg" onClick={() => navigate(`/prototype/${project.prototypeId}`)}
>
                  View prototype
                </Button>
                <Button className="" variant="outline" size="lg" onClick={handleNextProject}>
                  Next case study
                </Button>
              </div>
            </div>
